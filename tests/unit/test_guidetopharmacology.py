...
def test_meta_info(guidetopharmacology):
    ...
    assert resp.source_meta_.data_license_url == "https://creativecommons.org/licenses/by-sa/4.0/"  # noqa: E501
    assert re.match(r"\d{4}.\d+", resp.source_meta_.version)
    assert resp.source_meta_.data_url == "https://www.guidetopharmacology.org/download.jsp"  # noqa: E501
